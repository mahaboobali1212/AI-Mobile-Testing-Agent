...
Scenario: Device A dials Device B (555-0002), Device B immediately rejects and ends the call, verify that both devices return to idle state with no active call.
"""
import time
