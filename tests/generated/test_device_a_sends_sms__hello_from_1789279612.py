...
Scenario: Device A sends SMS 'Hello from Device A!' to Device B (555-0002), Device B verifies receipt and replies 'Message received loud and clear' to Device A.
"""
import time
